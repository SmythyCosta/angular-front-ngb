...
export class SettingFormComponent implements OnInit {
    ...
    insertAction() {
        ...
        // ================ formData ================
        formData.append('company_name', this.settingAddForm.value.company_name);
        formData.append('phone', this.settingAddForm.value.phone);
        formData.append('email', this.settingAddForm.value.email);
        formData.append('address', this.settingAddForm.value.address);
        formData.append('currency', this.settingAddForm.value.currency);
